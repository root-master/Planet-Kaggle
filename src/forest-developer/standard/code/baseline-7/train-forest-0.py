...
def do_training():
    ...
    train_dataset = KgForestDataset('train-32479',#'train-8000',#'train-40479',  #'train-8000',##'train-3000',##
                                    transform=transforms.Compose([
                                        transforms.Lambda(lambda x: randomShiftScaleRotate(x, u=0.5, shift_limit=16, scale_limit=0.1, rotate_limit=45)),
...
def do_submission2():
    out_dir ='/root/share/project/pytorch/results/kaggle-forest/PyNet_11-jpg-2'
    ...
    csv_files = [
        '/root/share/project/pytorch/results/kaggle-forest/__old_2__/MultiNet-02a-jpg/submissions/average2/results-0.92480.csv',
        '/root/share/project/pytorch/results/kaggle-forest/__old_2__/pynet-18a-jpg/submissions/average2/results-0.92713.csv',
        '/root/share/project/pytorch/results/kaggle-forest/__old_2__/PyNet_4-all-1/submissions/average/results-0.92674.csv',
        '/root/share/project/pytorch/results/kaggle-forest/PyNet_11-jpg-2/submissions/average/results-0.92661.csv',
    ...
    test_dir = out_dir +'/submissions/average13'
    os.makedirs(test_dir, exist_ok=True)
